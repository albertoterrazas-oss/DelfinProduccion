...
export async function excelTemplateIncidencias(excelData, excelColumns, estado, name) {
    ...
    worksheet = await generatTemplate(worksheet, workbook, ('Reportes ' + fch), 'F', estado)
